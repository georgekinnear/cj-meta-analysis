...
splits_stats_all <- splits_stats %>%
  ...
  summarise(ssr_x = median(ssr_x),
            median_split_corr = median(split_corr)) %>%
...
meta_analysis_data %>% 
  ...
  labs(#title = paste("r = ", toString(PropvsSSR_r), ", p = ", toString(PropvsSSR_p)), 
       x = "Proportion of correct judgements", y = "SSR")
...
```{r ssr_x-vs-prop-all}
  ...
  splits_stats_three %>% 
  mutate(pt_label = ifelse(median_split_corr < 0.5 | ssr_x < 0.7, study, "")) %>% 
  ggplot(aes(y = ssr_x, x = prop_correct_judgements, label = pt_label)) +
  geom_vline(xintercept = 0.7, alpha = 0.3, colour = "#CC0000") +
  geom_hline(yintercept = 0.7, alpha = 0.3, colour = "#CC0000") +
  geom_abline(slope = 1, intercept = 0, alpha = 0.5) +
  geom_point(alpha = 0.4) +
  ...
  labs(#title = paste("r = ", toString(SSR_xvProp_r_all), ", p = ", toString(SSR_xvProp_p_all)), 
       y = "SSR", x = "Proportion of correct judgements")
...
```{r ssr_x-vs-prop-10}
 ...
 splits_stats_three_10 <- splits_stats_three %>%
  ...
  SSR_xvProp_10 <- cor.test(splits_stats_three_10$ssr_x,
                                  splits_stats_three_10$prop_correct_judgements)
...
```{r ssr_x-vs-prop-20}
 ...
 splits_stats_three_20 <- splits_stats_three %>%
  ...
  SSR_xvProp_20 <- cor.test(splits_stats_three_20$ssr_x,
                                  splits_stats_three_20$prop_correct_judgements)
...
```{r ssr_x-vs-prop-34}
 ...
 splits_stats_three_34 <- splits_stats_three %>%
  ...
  SSR_xvProp_34 <- cor.test(splits_stats_three_34$ssr_x,
                                  splits_stats_three_34$prop_correct_judgements)
...
meta_analysis_data %>% 
  ...
  labs(title = paste("r = ", toString(PropvsElo_r), ", p = ", toString(PropvsElo_p)), 
       x = "Proportion of correct judgements", y = "Elo")
...
meta_analysis_data %>% 
  ...
  labs(#title = paste("r = ", toString(PropvsSplithalves_r), ", p = ", toString(PropvsSplithalves_p)), 
       x = "Proportion of correct judgements", y = "Split halves")
...
```{r min-max-median-reliabilities}
  
#create data frame including ssr_x, r, prop
  min_max_median <- splits_stats %>% 
  separate(file, into = c(NA, "study", NA), sep = "/") %>%
  left_join(meta_analysis_data, by = c("study" = "judging_session")) %>% 
  group_by(study) %>% 
  summarise(ssr_x = median(ssr_x), median_split_corr = median(split_corr)) %>% 
  filter(!is.na(ssr_x)) %>%  
  merge(meta_analysis_data[,c(1,29,31)], by.x = "study", by.y  = "judging_session") %>%
  as.data.frame

  colnames(min_max_median)[3:4] <- c("r", "prop")

  min_max_median_summary <- 
    data.frame(threshold = c(rep(0,3),rep(5,3),rep(10,3),rep(17,3)),
      measure = c(rep(c("SSR", "r", "prop"),4)),
      min = c(min(min_max_median$ssr_x),
              min(min_max_median$r),
              min(min_max_median$prop),
              min(min_max_median$ssr_x[min_max_median$CperR>9]),
              min(min_max_median$r[min_max_median$CperR>9]),
              min(min_max_median$prop[min_max_median$CperR>9]),
              min(min_max_median$ssr_x[min_max_median$CperR>19]),
              min(min_max_median$r[min_max_median$CperR>19]),
              min(min_max_median$prop[min_max_median$CperR>19]),
              min(min_max_median$ssr_x[min_max_median$CperR>33]),
              min(min_max_median$r[min_max_median$CperR>33]),
              min(min_max_median$prop[min_max_median$CperR>33])),
      max = c(max(min_max_median$ssr_x),
              max(min_max_median$r),
              max(min_max_median$prop),
              max(min_max_median$ssr_x[min_max_median$CperR>9]),
              max(min_max_median$r[min_max_median$CperR>9]),
              max(min_max_median$prop[min_max_median$CperR>9]),
              max(min_max_median$ssr_x[min_max_median$CperR>19]),
              max(min_max_median$r[min_max_median$CperR>19]),
              max(min_max_median$prop[min_max_median$CperR>19]),
              max(min_max_median$ssr_x[min_max_median$CperR>33]),
              max(min_max_median$r[min_max_median$CperR>33]),
              max(min_max_median$prop[min_max_median$CperR>33])),
        med = c(median(min_max_median$ssr_x),
              median(min_max_median$r),
              median(min_max_median$prop),
              median(min_max_median$ssr_x[min_max_median$CperR>9]),
              median(min_max_median$r[min_max_median$CperR>9]),
              median(min_max_median$prop[min_max_median$CperR>9]),
              median(min_max_median$ssr_x[min_max_median$CperR>19]),
              median(min_max_median$r[min_max_median$CperR>19]),
              median(min_max_median$prop[min_max_median$CperR>19]),
              median(min_max_median$ssr_x[min_max_median$CperR>33]),
              median(min_max_median$r[min_max_median$CperR>33]),
              median(min_max_median$prop[min_max_median$CperR>33])))
                                       
min_max_median_summary[,3:5] <- round(min_max_median_summary[,3:5],2)
min_max_median_summary 
